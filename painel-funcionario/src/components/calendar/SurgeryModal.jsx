...
const SurgeryModal = ({ appointment, selectedDate, onSave, onClose }) => {
  const { searchPatients, getHospitals, getSurgeryTypes, getEmployees, getJourneyProtocols } = useApi();
  ...
  const [formData, setFormData] = useState({
    ...
    hospital_id: '',
    surgery_type: '',
    surgery_date: selectedDate.toISOString().split('T')[0],
    surgery_time: '09:00',
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...formData,
      surgery_start_at: surgery_start_at.toISOString(),
      surgery_end_at: surgery_end_at.toISOString(),
    };
    onSave(payload);
  };
