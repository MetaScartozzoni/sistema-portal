...
function SecretaryDashboardDemoPage() {
  ...
  const showWipToast = () => {
    toast({
      ...
      description: "Esta funcionalidade está desativada nesta visualização.",
    });
  };
  ...
  return (
    <>
      <Helmet>
        <title>Dashboard da Secretaria - Demonstração</title>
        <meta name="description" content="Demonstração do sistema de gestão para secretaria da clínica médica." />
      </Helmet>
      
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 pb-24">
        <DashboardHeader 
          title="Dashboard Secretaria (Demo)"
...
export default SecretaryDashboardDemoPage;