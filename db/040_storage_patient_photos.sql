-- Bucket policies for patient photos (idempotente)
-- OBS: a criação do bucket deve ser feita pelo Dashboard/API (nome sugerido: patient-photos)

-- Policies na storage.objects
